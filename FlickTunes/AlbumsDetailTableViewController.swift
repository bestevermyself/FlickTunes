...
class AlbumsDetailTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        var backButton: UIBarButtonItem = UIBarButtonItem(title: "戻る", style: .plain, target: self, action: #selector(AlbumsDetailTableViewController.actionBackButton))
        var searchButton: UIBarButtonItem = UIBarButtonItem(barButtonSystemItem: UIBarButtonSystemItem.search, target: self, action: #selector(AlbumsDetailTableViewController.actionSearchButton))
